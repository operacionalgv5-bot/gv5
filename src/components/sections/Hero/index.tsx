        ...
        <div className={styles.gradeConteudo} ref={gradeRef}>
          <div className={styles.colunaTexto}>
            <div className={styles.blocoLogo}>
              <Image src="/logo.png" alt="GV5 Assessoria" width={54} height={40} className={styles.iconeLogo} />
            </div>
            <h2 className={styles.tituloAutoridade}>
              Sua empresa precisa da <span className={styles.destaqueVermelho}>maior assessoria de marketing digital</span> do ABC!
            </h2>
            <p className={styles.subtitulo}>Somos a engrenagem invisível das empresas que mais crescem no ABC.</p>
          ...
          <div className={styles.colunaImagem}>
            <div className={styles.envolturaImagemFundida}>
              <Image src="/hero.png" alt="Fundadores da GV5 Assessoria" width={720} height={520} priority className={styles.imagemHero} />
            </div>
          </div>
        </div>
      </div>
